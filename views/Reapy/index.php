...
<div id="main">
    <div class="module">
        <div class="title">《<?= Html::encode($film->title)?>》的影评</div>
        <div class="comment_q_list">
            <div class="comment_q">
                <div class="comment_q_top"><?= Html::encode($data[0]->title)?></div>
                <div class="comment_q_pic"><a href="#" target="_blank"><img alt="<?= Html::encode($user->name)?>" src="<?= Html::encode($user->photo)?>" /></a></div>
                <div class="comment_q_p">来自：<span><a href="#" target="_blank"><?= Html::encode($user->name)?></a> 评论的 <a href="#" target="_blank"><?= Html::encode($film->title)?></a> <img src="images/1.jpg" /></span></div>
        ...
        <div class="ziliao">
            <div class="pingfen">
                ...
                <p>评分: <?= Html::encode($film->score)?>分<span>（2人评价）</span></P>
            </div>
            <div class="zl_info">
                <li class="pic"><a href="#" target="_blank"><img alt="<?= Html::encode($film->title)?>" src="<?= Html::encode($film->img_url)?>" /></a>
                    <div class="down"><a href="#" target="_blank">点击下载</a></div>
                </li>
                <li class="wz"><a href="#" target="_blank"><b><?= Html::encode($film->title)?></b></a></li>
                ...
                <li class="ss">语言：<a href="#"><?= Html::encode($film->lanaguage_type)?></a></li>

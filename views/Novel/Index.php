    ...
    <div class="c_con">
        <div class="bord">
            ...
            <ul class="r_lis_con">
                ...
                <li><b>按类型</b><a href="#" target="_blank">全部</a>
                    <?php foreach ($type as $v): ?>
                    | <a href="#" class="all"><?= Html::encode($v['name'])?></a>
                 <?php endforeach ?>
                </li>
        ...
        <ul class="c_con_list">
            ...
            <li class="x1">
                <a href="<?= Url::to(['novelc/index','id'=>$v['id']])?>" target="_blank"><img src="<?= Html::encode($v['img_url'])?>" /></a>
                <p><?= Html::encode($v['type_id'])?></p>
                <div><a href="<?= Url::to(['novelc/index','id'=>$v['id']])?>" target="_blank"><?= Html::encode($v['title'])?></a> <img src="images/1.jpg" /> <em><?= Html::encode($v['score'])?></em></div>
            </li>
            <?php endforeach ?>
        </ul>
        <!--page-->

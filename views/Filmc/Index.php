...
<div id="main">
	...
	<div class="left">
        ...
        <!--评论开始-->
        <H4 id="comment"><?= Html::encode($data[0]->title)?>的影评<!--判断是否有评论，没有则不显示--><em>（<a href="#" target="_blank">共有32条影评</a>）</em><span><a href="#" target="_blank"><img src="images/write.jpg" border="0" /></a></span></H4>
        <div class="comment">
            ...
            <div class="comment_u">
                ...
                <ul>
                    ...
                    <li class="txt">
                        <p><a href="#" target="_blank">精神!.绝对忠实了原著的精神。</a><span><a href="#" target="_blank"></a> <img src="images/1.jpg" /></span></p>
                        <p style="padding-top:10px;line-height:22px;"><?= Html::encode($com[0]->content)?><a href="#" target="_blank">（查看全文）</a> | <a href="#" target="_blank">25人回应</a> | <a href="#" target="_blank">我来回应>></a></p>
                    </li>
                </ul>
                <?php endforeach;?>
            </div>

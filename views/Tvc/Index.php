...
<head>
    ...
    <title>家有四千金全集下载,更新至第24集大结局,剧情简介 - A67手机电视剧</title></title>
    <meta name="Description" content="A67手机电影提供家有四千金全集下载及剧情简介,目前已更新至第12集。让您在手机上也一样能看高清电视剧。" />
    <link href="css/style.css" type="text/css"  rel="stylesheet"/>
    <link href="css/dianshicontent.css" type="text/css"  rel="stylesheet"/>
        ...
        <div class="top">
            ...
            <div class="txt">
                <ul>
                    ...
                    <li><a href="javascript:;"  onclick="return addFavor('A67手机电视剧', 'http://www.a67.com/tv/')">加入收藏</a></li>
...
<div id="main">
    ...
    <div class="weizhi">当前位置：<a href="http://www.a67.com/">A67首页</a> > <a href="http://www.a67.com/list/1/">手机电视剧</a> > <a href="/list/1/45/" title="偶像剧">偶像剧</a> > 123</div>
    <div class="left">
        <div class="pic">
            <?php foreach ($data as $v): ?>
            <img alt="<?= Html::encode($v['tv_name'])  ?>" src="<?= Html::encode($v['img_url'])  ?>" />

        </div>
        <div class="info">
            <div class="pf">
                <H1><?= Html::encode($v['tv_name'])  ?><b>全集</b></H1>
        ...
        <div class="fenji">
            <div class="fenji_top" id="tabs1">
                <span id="downloadurls"><?= Html::encode($v['tv_name'])  ?>分集下载列表</span>
                <ul id="menu1">
                    <li onclick="setTab(1,0)" class="hover">第1-15集</li>
                    <li onclick="setTab(1,1)">第16-24集</li>
                </ul>
            </div>
            <div id="main1">
                <div class="fj_list">

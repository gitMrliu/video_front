...
<script>
    function but(form) {
        ...
        $.post("<?= Url::to(['comment/add'])?>",data,function (r) {
            console.log(r)
    ...
    <div class="module">
        ...
        <div class="comment_list">
            <div class="comment_fb">
                ...
                <div class="comment_fb_u">
                    ...
                    <input type='hidden' value='<?= Html::encode($film['id'])?>' id='film_id' />
                    <input type='hidden' value='<?= Html::encode($user['id'])?>' id='user_id' />
        ...
        <div class="ziliao">
            <div class="pingfen">
                ...
                <p><?= Html::encode($film->score)?>分<span>（8人评价）</span></P>
            </div>
            <div class="zl_info">
